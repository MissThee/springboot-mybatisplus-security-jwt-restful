...
public class ExceptionController {
    ...
    public Res httpMessageNotReadableException(HttpServletRequest request, Exception e) {
    ...
    @ResponseBody
    @ResponseStatus(code = HttpStatus.INTERNAL_SERVER_ERROR)
    public Res missingRequestHeaderExceptionException(HttpServletRequest request, Exception e) {
        log.debug(LogBuilder.requestLogBuilder(request, e));
    ...
    public Res exceptionHandler(HttpServletRequest request, Exception e) {
        log.error(LogBuilder.requestLogBuilder(request, e));
        e.printStackTrace();
