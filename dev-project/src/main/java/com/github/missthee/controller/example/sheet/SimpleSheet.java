...
public class SimpleSheet {
    ...
    public void excel(@RequestBody() JSONObject bodyJO, HttpServletResponse response) throws Exception {
        List<com.github.missthee.db.entity.primary.sheet.SimpleSheet> reportData = getData();
    ...
    private List<com.github.missthee.db.entity.primary.sheet.SimpleSheet> getData() {
        List<com.github.missthee.db.entity.primary.sheet.SimpleSheet> list = new ArrayList<>();
        //        此处实际由数据库获取数据
        list.add(new com.github.missthee.db.entity.primary.sheet.SimpleSheet().setReportDate("00:00").setPress_in(11D).setPress_out(224D));
        list.add(new com.github.missthee.db.entity.primary.sheet.SimpleSheet().setReportDate("01:00"));
        list.add(new com.github.missthee.db.entity.primary.sheet.SimpleSheet().setReportDate("02:00").setPress_in(51D));
        list.add(new com.github.missthee.db.entity.primary.sheet.SimpleSheet().setReportDate("03:00").setPress_in(16D).setPress_out(224D));
        return list;
    }
}
