...
public class UserImp implements UserService, UserInfoForJWT {
    ...
    @Override
    public Long insertOne(UserControllerVO.InsertOneReq insertOneReq) {
    ...
    @Override
    public Boolean updateOne(UserControllerVO.UpdateOneReq updateOneReq) {
    ...
    @Override
    public List<User> selectList(UserControllerVO.SelectListReq selectListReq) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, NoSuchFieldException, InvalidAttributeValueException {
