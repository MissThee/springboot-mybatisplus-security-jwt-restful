...
public class RoleController {
    ...
    public Res<SysRoleVO.InsertOneRes> insertOne(@RequestBody SysRoleVO.InsertOneReq insertOneReq) {
    ...
    @PatchMapping()
    @PreAuthorize("isAuthenticated() and (hasPermission(null,'[ADMIN]') or hasPermission(null,'role'))")
    public Res updateOne(@RequestBody SysRoleVO.UpdateOneReq updateOneReq) {
