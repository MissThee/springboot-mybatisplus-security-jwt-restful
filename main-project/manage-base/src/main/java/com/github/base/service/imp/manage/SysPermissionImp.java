...
@Service
public class SysPermissionImp extends ServiceImpl<SysPermissionMapper, SysPermission> implements SysPermissionService {
    private final MapperFacade mapperFacade;
    private final SysPermissionMapper permissionMapper;

    @Autowired
    public SysPermissionImp(SysPermissionMapper permissionMapper, MapperFacade mapperFacade) {
