...
public class ComplexSheet {
    ...
    private ArrayList<ColumnConfig> getColumnMap() {
        //前端网页数据所需的列，与后台导出excel所需的列统一在此设置
        //前端数据列，取map的id集合
        //excel数据列，取value非空
        return new ArrayList<ColumnConfig>() {{
            add(new ColumnConfig("id", "").setNoDataBaseColumn());
            add(new ColumnConfig("report_time", "1"));
            add(new ColumnConfig("cyg_yw1", "1"));
            add(new ColumnConfig("cyg_jm1", "1"));
            add(new ColumnConfig("cyg_kr1", "1"));
            add(new ColumnConfig("cyg_yw2", "1"));
            add(new ColumnConfig("cyg_jm2", "1"));
            add(new ColumnConfig("cyg_kr2", "1"));
            add(new ColumnConfig("pi_1150", "1"));
            add(new ColumnConfig("ti_1270", "1"));
            add(new ColumnConfig("ft109", "1"));
            add(new ColumnConfig("ti_1250", "1"));
            add(new ColumnConfig("pi_1090", "1"));
            add(new ColumnConfig("ti_1260", "1"));
            add(new ColumnConfig("pi_1100", "1"));
            add(new ColumnConfig("ti_1230", "1"));
            add(new ColumnConfig("ti_1240", "1"));
            add(new ColumnConfig("pi_1140", "1"));
            add(new ColumnConfig("pi_1110", "1"));
            add(new ColumnConfig("pi_1120", "1"));
            add(new ColumnConfig("ti_1200", "1"));
            add(new ColumnConfig("pi_1070", "1"));
            add(new ColumnConfig("jiarelu1", "1"));
            add(new ColumnConfig("jiarelu2", "1"));
            add(new ColumnConfig("jiarelu3", "1"));
            add(new ColumnConfig("rq_ckyl", "1"));
            add(new ColumnConfig("rq_ljds", "1"));
            add(new ColumnConfig("ranqiliang", "1"));
            add(new ColumnConfig("pi_1060", "1"));
            add(new ColumnConfig("ti_1150", "1"));
            add(new ColumnConfig("ft104s", "1"));
            add(new ColumnConfig("ft_1040", "1"));
            add(new ColumnConfig("rsb_by1", "1"));
            add(new ColumnConfig("rsb_by2", "1"));
            add(new ColumnConfig("rsb_by3", "1"));
            add(new ColumnConfig("lt_1030", "1"));
            add(new ColumnConfig("hsg_wd", "1"));
            add(new ColumnConfig("pi_1080", "1"));
            add(new ColumnConfig("ti_1210", "1"));
            add(new ColumnConfig("pi_1010", "1"));
            add(new ColumnConfig("ti_1010", "1"));
            add(new ColumnConfig("ft_1010", "1"));
            add(new ColumnConfig("ft101s", "1"));
            add(new ColumnConfig("cshrq_hgwd", "1"));
            add(new ColumnConfig("ti_1020", "1"));
            add(new ColumnConfig("ti_1030", "1"));
            add(new ColumnConfig("ti_1220", "1"));
            add(new ColumnConfig("ws_yl", "1"));
            add(new ColumnConfig("ws_wd", "1"));
            add(new ColumnConfig("ws_llj", "1"));
            add(new ColumnConfig("yeliang", "1").setNoDataBaseColumn());
        }};
    }
