...
-- ----------------------------
-- Table structure for form_test1
-- ----------------------------
DROP TABLE IF EXISTS `form_test1`;
CREATE TABLE `form_test1`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `form_column1` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `form_column2` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `form_column3` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `form_column_str` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `form_column_boolean` bit(1) NULL DEFAULT b'0',
  `form_column_date` datetime(0) NULL DEFAULT NULL,
  `form_column_timestamp` timestamp(3) NULL DEFAULT NULL,
  `form_column_number` int(11) NULL DEFAULT NULL,
