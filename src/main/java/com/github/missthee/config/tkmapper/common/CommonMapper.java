...
import com.github.missthee.config.tkmapper.custom.MyExampleMapper;
...
public interface CommonMapper<T> extends Mapper<T>, MySqlMapper<T>, MyInsertMapper<T>,  MyExampleMapper<T> {
