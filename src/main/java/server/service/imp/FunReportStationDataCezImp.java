...
import server.db.primary.mapper.reportform.FunReportStationDataCezResMapper;
import server.db.primary.mapper.reportform.FunReportStationDataCylOilExtraMapper;
import server.db.primary.model.reportform.ReportStationDataCez_Res;
import server.db.primary.model.reportform.ReportStationDataCylOil_Extra;
...
public class FunReportStationDataCezImp implements FunReportStationDataCezService {
    ...
    @Override
    public boolean updateData(ReportStationDataCez_Res reportData) {
