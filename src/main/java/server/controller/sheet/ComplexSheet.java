...
//行分隔
            ...
            add(new ExcelExport.HeaderCell("储油罐", 1, 0, 6, 1));
            add(new ExcelExport.HeaderCell("外输泵", 7, 0, 3, 1));
            add(new ExcelExport.HeaderCell("进站（来液升温）换热器", 10, 0, 6, 1));
            add(new ExcelExport.HeaderCell("分离缓冲罐", 16, 0, 3, 1));
            add(new ExcelExport.HeaderCell("加热炉", 19, 0, 5, 1));
            add(new ExcelExport.HeaderCell("燃气", 24, 0, 3, 1));
            add(new ExcelExport.HeaderCell("热水泵", 27, 0, 7, 1));
            add(new ExcelExport.HeaderCell("热回水罐", 34, 0, 2, 1));
            add(new ExcelExport.HeaderCell("燃油泵", 36, 0, 2, 1));
            add(new ExcelExport.HeaderCell("掺水泵", 38, 0, 4, 1));
            add(new ExcelExport.HeaderCell("掺水换热器", 42, 0, 3, 1));
            add(new ExcelExport.HeaderCell("燃油换热器", 45, 0, 1, 1));
            add(new ExcelExport.HeaderCell("外输记录", 46, 0, 4, 1));
//行分隔
            add(new ExcelExport.HeaderCell("1#", 1, 1, 3, 1));
            add(new ExcelExport.HeaderCell("2#", 4, 1, 3, 1));
            add(new ExcelExport.HeaderCell("出口汇管", 7, 1, 3, 1));
            add(new ExcelExport.HeaderCell("出口汇管", 10, 1, 4, 1));
            add(new ExcelExport.HeaderCell("1#", 14, 1, 1, 1));
            add(new ExcelExport.HeaderCell("2#", 15, 1, 1, 1));
            add(new ExcelExport.HeaderCell("汇管", 16, 1, 1, 1));
            add(new ExcelExport.HeaderCell("1#", 17, 1, 1, 1));
            add(new ExcelExport.HeaderCell("2#", 18, 1, 1, 1));
            add(new ExcelExport.HeaderCell("出口汇管", 19, 1, 2, 2));
            add(new ExcelExport.HeaderCell("1#", 21, 1, 1, 2));
            add(new ExcelExport.HeaderCell("2#", 22, 1, 1, 2));
            add(new ExcelExport.HeaderCell("3#", 23, 1, 1, 2));
            add(new ExcelExport.HeaderCell("#", 24, 1, 3, 2));
            add(new ExcelExport.HeaderCell("出口汇管", 27, 1, 4, 2));
            add(new ExcelExport.HeaderCell("1#", 31, 1, 1, 2));
            add(new ExcelExport.HeaderCell("2#", 32, 1, 1, 2));
            add(new ExcelExport.HeaderCell("3#", 33, 1, 1, 2));
            add(new ExcelExport.HeaderCell("液位m", 34, 1, 1, 3));
            add(new ExcelExport.HeaderCell("温度℃", 35, 1, 1, 3));
            add(new ExcelExport.HeaderCell("#", 36, 1, 2, 1));
            add(new ExcelExport.HeaderCell("出口汇管", 38, 1, 4, 2));
            add(new ExcelExport.HeaderCell("出口汇管", 42, 1, 1, 2));
            add(new ExcelExport.HeaderCell("1#", 43, 1, 1, 2));
            add(new ExcelExport.HeaderCell("2#", 44, 1, 1, 2));
            add(new ExcelExport.HeaderCell("油", 45, 1, 1, 2));
            add(new ExcelExport.HeaderCell("压力MPa", 46, 1, 1, 3));
            add(new ExcelExport.HeaderCell("温度℃", 47, 1, 1, 3));
            add(new ExcelExport.HeaderCell("流量计读数m³", 48, 1, 1, 3));
            add(new ExcelExport.HeaderCell("液量m³", 49, 1, 1, 3));
//行分隔
            add(new ExcelExport.HeaderCell("时间", 0, 2, 1, 2));
            add(new ExcelExport.HeaderCell("液位", 1, 2, 1, 1));
            add(new ExcelExport.HeaderCell("界面", 2, 2, 1, 1));
            add(new ExcelExport.HeaderCell("库容", 3, 2, 1, 1));
            add(new ExcelExport.HeaderCell("液位", 4, 2, 1, 1));
            add(new ExcelExport.HeaderCell("界面", 5, 2, 1, 1));
            add(new ExcelExport.HeaderCell("库容", 6, 2, 1, 1));
            add(new ExcelExport.HeaderCell("压力", 7, 2, 1, 1));
            add(new ExcelExport.HeaderCell("温度", 8, 2, 1, 1));
            add(new ExcelExport.HeaderCell("流量计读数m³", 9, 2, 1, 2));
            add(new ExcelExport.HeaderCell("油", 10, 2, 2, 1));
            add(new ExcelExport.HeaderCell("水", 12, 2, 2, 1));
            add(new ExcelExport.HeaderCell("油", 14, 2, 1, 1));
            add(new ExcelExport.HeaderCell("油", 15, 2, 1, 1));
            add(new ExcelExport.HeaderCell("天然气", 16, 2, 1, 1));
            add(new ExcelExport.HeaderCell("天然气", 17, 2, 1, 1));
            add(new ExcelExport.HeaderCell("天然气", 18, 2, 1, 1));
            add(new ExcelExport.HeaderCell("出口汇管", 36, 2, 2, 1));
//行分隔
            add(new ExcelExport.HeaderCell("m", 1, 3, 1, 1));
            add(new ExcelExport.HeaderCell("m", 2, 3, 1, 1));
            add(new ExcelExport.HeaderCell("t", 3, 3, 1, 1));
            add(new ExcelExport.HeaderCell("m", 4, 3, 1, 1));
            add(new ExcelExport.HeaderCell("m", 5, 3, 1, 1));
            add(new ExcelExport.HeaderCell("t", 6, 3, 1, 1));
            add(new ExcelExport.HeaderCell("MPa", 7, 3, 1, 1));
            add(new ExcelExport.HeaderCell("℃", 8, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 10, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 11, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 12, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 13, 3, 1, 1));
            add(new ExcelExport.HeaderCell("出口温度℃", 14, 3, 1, 1));
            add(new ExcelExport.HeaderCell("出口温度℃", 15, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 16, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 17, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 18, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 19, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 20, 3, 1, 1));
            add(new ExcelExport.HeaderCell("出口温度℃", 21, 3, 1, 1));
            add(new ExcelExport.HeaderCell("出口温度℃", 22, 3, 1, 1));
            add(new ExcelExport.HeaderCell("出口温度℃", 23, 3, 1, 1));
            add(new ExcelExport.HeaderCell("出口压力MPa", 24, 3, 1, 1));
            add(new ExcelExport.HeaderCell("流量计读数m³", 25, 3, 1, 1));
            add(new ExcelExport.HeaderCell("燃气量m³", 26, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 27, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 28, 3, 1, 1));
            add(new ExcelExport.HeaderCell("流量计读数m³(瞬时)", 29, 3, 1, 1));
            add(new ExcelExport.HeaderCell("流量计读数m³(累计)", 30, 3, 1, 1));
            add(new ExcelExport.HeaderCell("泵压MPa", 31, 3, 1, 1));
            add(new ExcelExport.HeaderCell("泵压MPa", 32, 3, 1, 1));
            add(new ExcelExport.HeaderCell("泵压MPa", 33, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 36, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 37, 3, 1, 1));
            add(new ExcelExport.HeaderCell("压力MPa", 38, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 39, 3, 1, 1));
            add(new ExcelExport.HeaderCell("流量m³(累计)", 40, 3, 1, 1));
            add(new ExcelExport.HeaderCell("流量m³/h(瞬时)", 41, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 42, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 43, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 44, 3, 1, 1));
            add(new ExcelExport.HeaderCell("温度℃", 45, 3, 1, 1));
        }};
