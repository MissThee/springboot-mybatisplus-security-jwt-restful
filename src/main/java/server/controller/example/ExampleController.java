...
public class ExampleController {
    ...
    public Res everyone() {
        return Res.successMsg("WebController：everyone");
    }
    ...
    public Res requireRole1() {
        return Res.successMsg("WebController：You are visiting require_role [role1]");
    }

    @RequestMapping("/require_role3")
    @RequiresRoles("role3")
    public Res requireRole3() {
        return Res.successMsg("WebController：You are visiting require_role [role3]");
    }
